...
import type {CoursesArrayModel} from "./CoursesArrayModel.ts";
...
export let coursesAndDurationArray: CourseModel[] = [
...
let coursesArray: CoursesArrayModel[] = [
    {
